...
public class PmsProductAttributeCategoryController {
    ...
    public Object create(@RequestParam String name) {
        ...
        // 添加商品属性分类
        boolean b = productAttributeCategoryService.createProductAttributeCategory(name);
    ...
    public Object update(@PathVariable Long id, @RequestParam String name) {
        // 修改商品属性分类
        boolean b = productAttributeCategoryService.updateProductAttributeCategoryById(id, name);
        return new CommonResult().success(null);
    }
    ...
    public Object getList(@RequestParam(defaultValue = "5") Integer pageSize, @RequestParam(defaultValue = "1") Integer pageNum) {
        // 分页获取所有商品属性分类
        Map<String, Object> pageProductAttributeCategory = productAttributeCategoryService.pageProductAttributeCategory(pageNum, pageSize);
        return new CommonResult().success(pageProductAttributeCategory);
    }
    ...
    public Object getListWithAttr() {
        // 获取所有商品属性分类及其下属性
        List<PmsProductAttributeCategoryItem> productAttributeCategoryList = productAttributeCategoryService.getProductAttributeCategoryList();
