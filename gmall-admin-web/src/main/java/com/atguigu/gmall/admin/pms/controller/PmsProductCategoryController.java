...
public class PmsProductCategoryController {
    ...
    public Object create(@Validated @RequestBody PmsProductCategoryParam productCategoryParam,
        ...
        // 添加产品分类
        boolean b = productCategoryService.createProductCategory(productCategoryParam);
    ...
    public Object update(@PathVariable Long id,
                         ...
                         BindingResult result) {
        // 修改商品分类
        boolean b = productCategoryService.updateProductCategoryById(id, productCategoryParam);
        return new CommonResult().success(null);
    }
    ...
    public Object getList(@PathVariable Long parentId,
        ...
        // 分页查询商品分类
        Map<String, Object> pageProductCategory = productCategoryService.pageProductCategory(pageNum, pageSize, parentId);
        return new CommonResult().success(pageProductCategory);
    }
    ...
    public Object delete(@PathVariable Long id) {
        // 删除商品分类
        boolean b = productCategoryService.deleteProductCategoryById(id);
        return new CommonResult().success(null);
    }
    ...
    public Object updateNavStatus(@RequestParam("ids") List<Long> ids, @RequestParam("navStatus") Integer navStatus) {
        // 修改导航栏显示状态
        boolean b = productCategoryService.updateNavStatusByIds(ids,navStatus);
        return new CommonResult().success(null);
    }
    ...
    public Object updateShowStatus(@RequestParam("ids") List<Long> ids, @RequestParam("showStatus") Integer showStatus) {
        // 修改显示状态
        boolean b = productCategoryService.updateShowStatusByIds(ids,showStatus);
        return new CommonResult().success(null);
    }
    ...
    public Object listWithChildren() {
        ...
        return new CommonResult().success(productCategoryWithChildrenItemList);
    }
}
