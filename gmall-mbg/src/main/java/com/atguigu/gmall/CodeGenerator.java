...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E:/ProgramFiles/project/gmall-parent/gmall-mbg" + "/src/main/java");
        gc.setAuthor("mei");
        ...
        dsc.setUrl("jdbc:mysql://192.168.36.135:3306/gmall_"+moduleName+"?useUnicode=true&useSSL=false&characterEncoding=utf8");
